  ...
  <main>
    <div class="container">
      ...
      <?php
        ...
        $sql_thongtin_Vsmart = "SELECT * FROM `thongtin_sanpham` WHERE `Nhãn hiệu` = \"Vsmart\"";
        $ketqua_Vsmart = Data::ExecuteQuery($sql_thongtin_Vsmart);
      ?>
      <ul style="
      margin: 0;
      padding: 0;
      ...
      flex-wrap: wrap;">
      <?php
        while ($row = mysqli_fetch_array($ketqua_Vsmart)) {
          $chuoi = <<<EOD
              <li 
              style="
