  ...
  <main>
    <div class="container">
      ...
      <?php
        ...
        $sql_thongtin_OPPO = "SELECT * FROM `thongtin_sanpham` WHERE `Nhãn hiệu` = \"OPPO\"";
        $ketqua_OPPO = Data::ExecuteQuery($sql_thongtin_OPPO);
      ?>
      <ul style="
      margin: 0;
      padding: 0;
      ...
      flex-wrap: wrap;">
      <?php
        while ($row = mysqli_fetch_array($ketqua_OPPO)) {
          $chuoi = <<<EOD
              <li 
              style="
