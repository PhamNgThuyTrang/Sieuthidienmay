  ...
  <main>
    <div class="container">
      ...
      <?php
        ...
        $sql_thongtin_Vivo = "SELECT * FROM `thongtin_sanpham` WHERE `Nhãn hiệu` = \"Vivo\"";
        $ketqua_Vivo = Data::ExecuteQuery($sql_thongtin_Vivo);
      ?>
      <ul style="
      margin: 0;
      padding: 0;
      ...
      flex-wrap: wrap;">
      <?php
        while ($row = mysqli_fetch_array($ketqua_Vivo)) {
          $chuoi = <<<EOD
              <li 
              style="
