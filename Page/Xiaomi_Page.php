  ...
  <main>
    <div class="container">
      ...
      <?php
        ...
        $sql_thongtin_Xiaomi = "SELECT * FROM `thongtin_sanpham` WHERE `Nhãn hiệu` = \"Xiaomi\"";
        $ketqua_Xiaomi = Data::ExecuteQuery($sql_thongtin_Xiaomi);
      ?>
      <ul style="
      margin: 0;
      padding: 0;
      ...
      flex-wrap: wrap;">
      <?php
        while ($row = mysqli_fetch_array($ketqua_Xiaomi)) {
          $chuoi = <<<EOD
              <li 
              style="
