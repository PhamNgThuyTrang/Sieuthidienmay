  ...
  <main>
    <div class="container">
      ...
      <?php
        ...
        $sql_thongtin_Samsung = "SELECT * FROM `thongtin_sanpham` WHERE `Nhãn hiệu` = \"Samsung\"";
        $ketqua_Samsung = Data::ExecuteQuery($sql_thongtin_Samsung);
      ?>
      <ul style="
      margin: 0;
      padding: 0;
      ...
      flex-wrap: wrap;">
      <?php
        while ($row = mysqli_fetch_array($ketqua_Samsung)) {
          $chuoi = <<<EOD
              <li 
              style="
