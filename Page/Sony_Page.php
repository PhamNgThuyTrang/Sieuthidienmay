  ...
  <main>
    <div class="container">
      ...
      <?php
        ...
        $sql_thongtin_Sony = "SELECT * FROM `thongtin_sanpham` WHERE `Nhãn hiệu` = \"Sony\"";
        $ketqua_Sony = Data::ExecuteQuery($sql_thongtin_Sony);
      ?>
      <ul style="
      margin: 0;
      padding: 0;
      ...
      flex-wrap: wrap;">
      <?php
        while ($row = mysqli_fetch_array($ketqua_Sony)) {
          $chuoi = <<<EOD
              <li 
              style="
